...
class TestDevelopmentConfig(TestCase):
    ...
    def test_app_is_development(self):
        ...
        self.assertTrue(
            app.config['SQLALCHEMY_DATABASE_URI'] == 'postgres://postgres:password@127.0.0.1:5432/dev'
        )
...
class TestTestingConfig(TestCase):
    ...
    def test_app_is_testing(self):
        ...
        self.assertTrue(
            app.config['SQLALCHEMY_DATABASE_URI'] == 'postgres://postgres:password@127.0.0.1:5432/test'
        )
